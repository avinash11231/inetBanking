...
public class PassengerDetailsPage {
	...
	WaitHelper waitHelper;
		...
		@FindBy(xpath="//button[@class=\"enhanced-takeover__product-dismiss-cta ry-button--anchor-blue ry-button--anchor ng-star-inserted\"]")
		@CacheLookup
		...
		{
			waitHelper.WaitForElement(dismissPopup, 30);
			dismissPopup.click();
		}
