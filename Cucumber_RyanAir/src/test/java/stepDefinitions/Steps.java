...
public class Steps<fp> extends BaseClass {
	// Cucumber 'Before' annotation
		@Before
		public void setup() throws IOException
		{
			// Added loggers to our project
			logger = Logger.getLogger("Cucumber_RyanAir"); 
			...
			driver = new InternetExplorerDriver();// Launches IE Browser
		...
		//PassengerDetails StepDefinitions

		@When("User selects Title Dropdown")
		public void userSelectsTitleDropdown() throws InterruptedException 
		{
		...
		public void userEntersFirstNameLastName(String firstname, String lastname) throws InterruptedException 
		{
		...
		public void userSelectsAllocationOption() throws InterruptedException 
		{
		...
		public void userSelectsCabinBagOption() throws InterruptedException 
		{
			Thread.sleep(4000);
			...
			logger.info("******  Dismissing Baggage Popup  ******");
			pp.dismissPopup();  
		}
		
		@And("User selects extra options and continue")
		public void userSelectsExtraOptionsAndContinue() throws InterruptedException 
		{
			Thread.sleep(4000);
		...
		public void userClicksViewBasket() throws InterruptedException 
		{
			Thread.sleep(5000);
		...
		public void userClicksCheckoutBtn() throws InterruptedException 
		{
		...
		// PaymentDetails StepDefinitions
		...
		public void user_should_get_transaction_could_not_be_processed_message() throws InterruptedException 
		{
			...
			{
			  logger.info("ERROR MESSAGE VERIFIED. Test Case Passed");
			}
			
			else
			{
			        logger.info("ERROR MESSAGE NOT VERIFIED. Test Case Failed");	
			}
